...
*-----------------------------------------------------------------------------*
   ...
   LOCAL aCFiles       := ARRAY( aDir( ProjectFolder + "OBJ\*.C" ) ) // kenny ooi 170615
   LOCAL aObjFiles     := ARRAY( aDir( ProjectFolder + "OBJ\*.O" ) )
   LOCAL aMapFiles     := ARRAY( aDir( ProjectFolder + "*.MAP"   ) )
   LOCAL aTdsFiles     := ARRAY( aDir( ProjectFolder + "*.TDS"   ) )
   LOCAL i             AS NUMERIC
