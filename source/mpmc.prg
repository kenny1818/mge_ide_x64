...
*-----------------------------------------------------------------------------*
   ...
   Out += "USER_FLAGS = " + iif( !empty( aextdat[ 1 ] ) ,trim( aextdat[ 1 ] ) ,'' ) + CRLF
   ...
   Out += "COBJFLAGS =  -c -O2 -tW -M  -I" + FixFolder( BccFolder ) + "INCLUDE -I$(INCLUDE_DIR) -L" + FixFolder( BccFolder ) + "LIB" + adduserlibincpath() + CRLF
   ...
   IF xHb == .F.
      ...
      Out += " echo $(HRB_LIB_DIR)\hbwin.lib + >> b32.bc"    + CRLF
      Out += " echo $(HRB_LIB_DIR)\xhb.lib + >> b32.bc"      + CRLF
      Out += " echo $(HRB_LIB_DIR)\bostaurus.lib + >> b32.bc"+ CRLF
      Out += " echo $(HRB_LIB_DIR)\hbvpdf.lib + >> b32.bc"   + CRLF
   ELSE
      ...
      Out += " echo $(HRB_LIB_DIR)\tip.lib + >> b32.bc"      + CRLF
      Out += " echo $(HRB_LIB_DIR)\bostaurus.lib + >> b32.bc"+ CRLF
      Out += " echo $(HRB_LIB_DIR)\hbvpdf.lib + >> b32.bc"   + CRLF
   ENDIF
   ...
   IF zs
      IF aData[ _HARBOUR ] = ".T."
         Out += " echo $(HRB_LIB_DIR)\hbziparc.lib + >> b32.bc" + CRLF
         Out += " echo $(HRB_LIB_DIR)\hbmzip.lib   + >> b32.bc" + CRLF
         Out += " echo $(HRB_LIB_DIR)\minizip.lib  + >> b32.bc" + CRLF
         Out += " echo $(HRB_LIB_DIR)\hbzlib.lib   + >> b32.bc" + CRLF
      ELSE
...
*-----------------------------------------------------------------------------*
   ...
   c += "BccFolder=C:\BORLAND\BCC58"       + CRLF
...
RETURN( y )
*****************
static func adduserlibincpath()
local lcret := ''
if !empty( aextdat[ 2 ] )
  lcret += ' ' + trim( aextdat[ 2 ] )
endif
if !empty( aextdat[ 3 ] )
  lcret += ' -L' + trim( aextdat[ 3 ] )
endif
if !empty( aextdat[ 4 ] )
  lcret += ' -I' + trim( aextdat[ 4 ] )
endif
